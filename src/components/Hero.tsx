export default function Hero() {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center px-6 sm:px-12 md:px-24 max-w-6xl mx-auto"
    >
      ...
      <div className="w-full flex flex-col-reverse lg:flex-row-reverse items-center gap-12 lg:gap-20 py-24">
        {/* Illustration placeholder */}
        <div className="image-animation z-10 select-none shrink-0">
          <div className="relative w-64 h-72 md:w-80 md:h-80 lg:w-96 lg:h-[26rem] flex items-center mx-auto">
        ...
        <div className="z-10 relative text-center lg:text-left flex-1">
          <span className="text-marrsgreen text-lg lg:text-xl font-medium dark:text-carrigreen tracking-wide">
            Hi, my name is
          </span>
          <div className="overflow-hidden mt-2">
            <h1 className="text-animation text-5xl md:text-6xl lg:text-8xl font-bold my-2 leading-tight">
              Your Name
            </h1>
          </div>
          <div className="overflow-hidden">
            <span className="text-animation text-3xl md:text-4xl lg:text-5xl block my-3 text-marrsgreen dark:text-carrigreen font-semibold">
              An AI Product Manager
            </span>
          </div>
          <div className="mt-4 mb-8 max-w-xl mx-auto lg:mx-0">
            <p className="text-lg leading-relaxed mb-2 text-slate-700 dark:text-slate-300">
          ...
          <a
            role="button"
            className="bg-marrsgreen hover:bg-marrslight active:bg-marrsdark dark:hover:bg-carrilight dark:active:bg-carridark dark:bg-carrigreen text-bglight dark:text-bgdark py-3 px-8 rounded-lg text-lg font-medium outline-marrsgreen dark:outline-carrigreen focus-visible:outline-double outline-offset-2 inline-block shadow-lg hover:shadow-xl transition-shadow"
